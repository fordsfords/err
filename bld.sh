...
gcc -Wall -pthread -g -o err_test -pthread err.c err_test.c; if [ $? -ne 0 ]; then exit 1; fi

gcc -Wall -pthread -g -o example1 -pthread err.c example1.c; if [ $? -ne 0 ]; then exit 1; fi
